...
$(document).ready(function() {
    ...
    var $container = $("#ct-controls"),
        tilt = new Slider("slider-tilt", {
            ...
            scales: 8,
            windowed: false,
//            tooltip: "Tilt the camera up or down."
        }),
        pan = new Slider("slider-pan", {
            ...
            vertical: false,
            windowed: false,
//            tooltip: "Pan the camera left or right."
        }),
        zoom = new Slider("slider-zoom", {
            ...
            vertical: false,
            windowed: false,
//            tooltip: "Increase or decrease zoom."
        });
    widgets.push(tilt, pan, zoom);
    
    /* Keyboard controls. */
    widgets.push(new Button("keyboard-move", {
        action: "pressKey",
        label: "Move",
    ...
    widgets.push(new Button("keyboard-scan", {
        action: "pressKey",
        label: "Scan",
    ...
    widgets.push(new Button("keyboard-abort", {
        action: "pressKey",
        label: "Abort",
    ...
    widgets.push(new LED("led-move", {
        field: "move-on",
        label: "Move On",
        windowed: false,
    }));
    
    widgets.push(new LED("led-scan", {
        field: "scan-on",
        label: "Scan On",
        windowed: false,
    }));
    
    widgets.push(new LED("led-abort", {
        field: "abort-on",
        label: "Abort",
        windowed: false,
    }));
    ...
    /* Bed controls. */
    widgets.push(new PushButton("button-yaw-left", {
        action: "move",
    ...
    widgets.push(new PushButton("button-yaw-right", {
        action: "move",
    ...
    widgets.push(new PushButton("button-roll-left", {
        action: "move",
    ...
    widgets.push(new PushButton("button-roll-right", {
        action: "move",
    ...
    widgets.push(new LED("led-homing", {
        field: "homing-error",
        label: "Homing Error",
        windowed: false,
    }));
...
function cameraInit()
{
    ...
    $.ajax({
        ...
        error: function() { setTimeout(function() { cameraInit(); }, 5000); }
    });
}
...
function deployMJPEGCamera(camera) 
{
    $("#ct-camera").html(
        !$.browser.msie ?
            ...
            "<img src='http://" + cameras[camera].address + "/mjpg/" + cameras[camera].index + "/video.mjpg?resolution=640x480'" +
