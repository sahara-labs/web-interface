# This is a modified copy of the keygen tool that shipped with Shibboleth SP. 
# It has been modified to create self signed certificates for use with the 
# Australian Access Federation (AAF) if you are using simpleSAMLphp.
